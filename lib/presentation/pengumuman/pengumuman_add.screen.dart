...
class PengumumanAddScreen extends StatefulWidget {
  const PengumumanAddScreen({Key? key}) : super(key: key);

  @override
  State<PengumumanAddScreen> createState() => _PengumumanAddScreenState();
}

class _PengumumanAddScreenState extends State<PengumumanAddScreen> {
                    ...
                    ButtonWidget(
                      ...
                      onTap: () {
                        ...
                        if (tJudul.text.isEmpty) {
                          ...
                          pengumumanController.addPengumuman(judul, deskripsi);
                        }
                      },
                    )
                  ],
